...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // node_modules/cellular-automata-rule-parser/utils/utils.js
  var require_utils = __commonJS({
    "node_modules/cellular-automata-rule-parser/utils/utils.js"(exports, module) {
      "use strict";
      var regexRange = /([0-9]+)\.\.([0-9]+)/;
      var regexProbability = /([0-9.]+):([0-9.]+)/;
      var utils = {};
  ...
  // node_modules/cellular-automata-rule-parser/formats/life.js
  var require_life = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/life.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^S?([0-9]*)\/B?([0-9]*)([MV]?)([0-9]*)$/i;
  ...
  // node_modules/cellular-automata-rule-parser/formats/extendedLife.js
  var require_extendedLife = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/extendedLife.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^ES?([0-9,.]*)\/B?([0-9,.]*)(M|V|von-neumann|moore|axis|corner|edge|face|)([0-9]*)$/i;
      function getNeighbourMethod(methodId) {
  ...
  // node_modules/cellular-automata-rule-parser/formats/extendedStochastic.js
  var require_extendedStochastic = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/extendedStochastic.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^ES?([0-9,.:]*)\/B?([0-9,.:]*)(M|V|von-neumann|moore|axis|corner|edge|face|)([0-9]*)$/i;
      function getNeighbourMethod(methodId) {
  ...
  // node_modules/cellular-automata-rule-parser/formats/generations.js
  var require_generations = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/generations.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^S?([0-9]*)\/B?([0-9]*)\/C?([1-9][0-9]*)([MV]?)([0-9]*)$/i;
      function getNeighbourMethod(methodId) {
        if (methodId === "V" || methodId === "v" || methodId === "von-neumann") {
          return "von-neumann";
        } else {
  ...
  // node_modules/cellular-automata-rule-parser/formats/extendedGenerations.js
  var require_extendedGenerations = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/extendedGenerations.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^ES?([0-9,.]*)\/B?([0-9,.]*)\/C?([1-9][0-9]*)(M|V|von-neumann|moore|axis|corner|edge|face|)([0-9]*)$/i;
      function getNeighbourMethod(methodId) {
        methodId = methodId.toLowerCase();
        if (methodId === "v") {
          return "von-neumann";
  ...
  // node_modules/cellular-automata-rule-parser/formats/cyclic.js
  var require_cyclic = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/cyclic.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^R([1-9][0-9]*)\/T([0-9]+)\/C([1-9][0-9]*)\/(NM|NN)(\/GH|)$/i;
      function getNeighbourMethod(methodId) {
  ...
  // node_modules/cellular-automata-rule-parser/formats/vote.js
  var require_vote = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/vote.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^([0-9]+)([MV]?)([0-9]*)$/i;
      function getNeighbourMethod(methodId) {
        if (methodId === "V" || methodId === "v" || methodId === "von-neumann") {
          return "von-neumann";
        } else {
  ...
  // node_modules/cellular-automata-rule-parser/formats/wolfram.js
  var require_wolfram = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/wolfram.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^(W|Rule)([0-9]{1,3})$/i;
  ...
  // node_modules/cellular-automata-rule-parser/formats/luky.js
  var require_luky = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/luky.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^LUKY([0-9])([0-9])([0-9])([0-9])$/i;
  ...
  // node_modules/cellular-automata-rule-parser/formats/nluky.js
  var require_nluky = __commonJS({
    "node_modules/cellular-automata-rule-parser/formats/nluky.js"(exports, module) {
      "use strict";
      var utils = require_utils();
      var ruleRegexp = /^NLUKY([0-9])([0-9])([0-9])([0-9])([0-9])$/i;
  ...
  // node_modules/cellular-automata-rule-parser/index.js
  var require_cellular_automata_rule_parser = __commonJS({
    "node_modules/cellular-automata-rule-parser/index.js"(exports, module) {
      "use strict";
      var formats = {
        life: require_life(),
        extendedLife: require_extendedLife(),
        extendedStochastic: require_extendedStochastic(),
        generations: require_generations(),
        extendedGenerations: require_extendedGenerations(),
        cyclic: require_cyclic(),
        vote: require_vote(),
        wolfram: require_wolfram(),
        luky: require_luky(),
        nluky: require_nluky()
      };
  ...
  // node_modules/von-neumann/index.js
  var require_von_neumann = __commonJS({
    "node_modules/von-neumann/index.js"(exports, module) {
      module.exports = function vonNeumann(range2, dimensions) {
        "use strict";
        range2 = range2 || 1;
        dimensions = dimensions || 2;
  ...
  // node_modules/unconventional-neighbours/functions/axis.js
  var require_axis = __commonJS({
    "node_modules/unconventional-neighbours/functions/axis.js"(exports, module) {
      module.exports = function axis(range2, dims) {
        "use strict";
        dims = dims || 2;
        range2 = range2 || 1;
        return recurse([], [], 0);
  ...
  // node_modules/unconventional-neighbours/functions/corner.js
  var require_corner = __commonJS({
    "node_modules/unconventional-neighbours/functions/corner.js"(exports, module) {
      module.exports = function corner(range2, dims) {
        "use strict";
        dims = dims || 2;
        range2 = range2 || 1;
        return recurse([], [], 0);
  ...
  // node_modules/unconventional-neighbours/functions/edge.js
  var require_edge = __commonJS({
    "node_modules/unconventional-neighbours/functions/edge.js"(exports, module) {
      module.exports = function edge(range2, dims) {
        "use strict";
        dims = dims || 2;
        range2 = range2 || 1;
        return recurse([], [], 0);
  ...
  // node_modules/unconventional-neighbours/functions/face.js
  var require_face = __commonJS({
    "node_modules/unconventional-neighbours/functions/face.js"(exports, module) {
      module.exports = function face(range2, dims) {
        "use strict";
        dims = dims || 2;
        range2 = range2 || 1;
        return recurse([], [], 0);
  ...
  // node_modules/unconventional-neighbours/index.js
  var require_unconventional_neighbours = __commonJS({
    "node_modules/unconventional-neighbours/index.js"(exports, module) {
      module.exports = {
        axis: require_axis(),
        corner: require_corner(),
        edge: require_edge(),
        face: require_face()
      };
    }
  ...
  // node_modules/cellular-automata/lib/utils/neighbourhood-functions.js
  var require_neighbourhood_functions = __commonJS({
    "node_modules/cellular-automata/lib/utils/neighbourhood-functions.js"(exports, module) {
      "use strict";
      var moore = require_moore();
      var vonNeumann = require_von_neumann();
      var unconventionalNeighbours = require_unconventional_neighbours();
      module.exports = {
        moore,
  ...
  // node_modules/cellular-automata/lib/utils/utils.js
  var require_utils2 = __commonJS({
    "node_modules/cellular-automata/lib/utils/utils.js"(exports, module) {
      "use strict";
      var ndarray = require_ndarray();
      var utils = {};
      utils.createArray = function(shape, defaultValue) {
        const length = shape.reduce(function(p, v) {
          return p * v;
        }, 1);
  ...
  // node_modules/cellular-automata/lib/cellular-automata.js
  var require_cellular_automata = __commonJS({
    "node_modules/cellular-automata/lib/cellular-automata.js"(exports, module) {
      "use strict";
      var parser = require_cellular_automata_rule_parser();
      var neighbourhoodFunctions = require_neighbourhood_functions();
      var utils = require_utils2();
      function CellularAutomata2(shape, defaultValue) {
        this.shape = shape;
      ...
      CellularAutomata2.prototype.shape = null;
      CellularAutomata2.prototype.stride = null;
      CellularAutomata2.prototype.dimension = null;
      CellularAutomata2.prototype.array = null;
      CellularAutomata2.prototype.workingArray = null;
      CellularAutomata2.prototype.rule = null;
      CellularAutomata2.prototype.rng = null;
      CellularAutomata2.prototype.neighbourhoodType = null;
      CellularAutomata2.prototype.neighbourhoodRange = null;
      CellularAutomata2.prototype.neighbourhood = null;
      CellularAutomata2.prototype.neighbourhoodNumber = null;
      CellularAutomata2.prototype.neighbourhoodValues = null;
      CellularAutomata2.prototype.outOfBoundValue = null;
      CellularAutomata2.prototype.outOfBoundWrapping = false;
      CellularAutomata2.prototype.outOfBoundClamping = false;
      CellularAutomata2.prototype.setRng = function(rng) {
        this.rng = rng || Math.random;
        return this;
      };
      CellularAutomata2.prototype.fillWithDistribution = function(distribution, rng) {
      ...
      CellularAutomata2.prototype.setOutOfBoundValue = function(outOfBoundValue) {
      ...
      CellularAutomata2.prototype.setRule = function(rule, neighbourhoodType, neighbourhoodRange) {
      ...
      CellularAutomata2.prototype.getNeighbours = function(cell) {
      ...
      CellularAutomata2.prototype.iterate = function(iterationNumber) {
      ...
      CellularAutomata2.prototype.apply = function(rule, iteration, neighbourhoodType, neighbourhoodRange) {
        return this.setRule(rule, neighbourhoodType, neighbourhoodRange).iterate(iteration);
      };
      module.exports = CellularAutomata2;
    }
  });

  // node_modules/cellular-automata/index.js
  var require_cellular_automata2 = __commonJS({
    "node_modules/cellular-automata/index.js"(exports, module) {
      "use strict";
      module.exports = require_cellular_automata();
    }
  });
  ...
  var _ = function() {
    ...
    return t2.prototype.next = function() {
      ...
      switch (this._prng) {
        ...
        case "mulberry32":
          return new s(this._str);
        case "xoshiro128ss":
          return new o(this._str);
        default:
          return this._wrap();
      }
  ...
  // src/useCelularAutomata.jsx
  var useCelularAutomata = ({ size: size2 = [10, 10, 10], rule = "23/3", seed: seed2 = "1" }) => {
    const [_2, setState] = (0, import_react3.useState)(null);
    const [iterations, setIterations] = (0, import_react3.useState)(0);
    const ca = (0, import_react3.useMemo)(() => {
      const rng = new rand_seed_es_default(seed2);
      const ca2 = new import_cellular_automata.default(size2);
      ca2.setOutOfBoundValue(0);
      ca2.fillWithDistribution([[0, 50], [1, 50]], () => rng.next());
      ca2.setRule(rule);
      return ca2;
    }, [size2]);
    return {
  ...
  var App = () => {
    ...
    const [rule, setRule] = (0, import_react6.useState)("345/2232");
